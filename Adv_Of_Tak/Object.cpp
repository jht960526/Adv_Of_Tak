...
Object::Object(const string& texttureFilePath)
{
	this->texture = new Texture;
	if(this->texture->loadFromFile(texttureFilePath))
	{
...
Object::Object(const string& textureFilePath, const Vector2f& position) : Object(textureFilePath)
{
